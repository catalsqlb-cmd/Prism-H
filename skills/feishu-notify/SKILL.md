...
This skill provides Feishu/Lark integration for Prism. It is designed as an **internal utility** — other skills call it at key events (experiment done, review scored, checkpoint waiting). It can also be invoked manually.
...
| Skill | Event | When |
|-------|-------|------|
| `/research-review` | `review_scored` | After each round's review score |
| `/research-review` | `pipeline_done` | Loop complete (positive or max rounds) |
| `/research-refine` | `review_scored` | After each round's review score |
| `/research-refine` | `pipeline_done` | All rounds complete |
| `/research-lit` | `checkpoint` | Literature survey complete |
| `/research-review` | `pipeline_done` | Critical review report ready |
