...
`tools/figure_renderer.py` (from Prism root). Invoke via:
...
Iterate until all three axes ≥ 7/10. The Prism tech report figures went through 5 rounds of this loop to reach C:7/R:7/S:8.
