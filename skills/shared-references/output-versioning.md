...
All Prism output files are organized by workflow stage:
...
2. Default staleness threshold: **24 hours** (individual skills may override — e.g., `research-review` uses 24h, `research-refine` uses 24h). If a skill defines its own threshold, that takes precedence.
