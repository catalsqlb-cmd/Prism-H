...
Every Prism skill accepts an optional `effort` parameter that controls how much work the system does. This affects breadth, depth, iterations, and coverage — but **never** the quality of cross-model review.
...
Current Prism behavior. What existing users get today. No breakage.
...
| Skill | Dimension | lite | balanced | max | beast |
|-------|-----------|------|----------|-----|-------|
| research-review | max rounds | 2 | 3-4 | 6 | 8+ (until converged) |
| research-review | fixes per round | 1-2 | 3-4 | 4-6 | all actionable |
| research-review | passes | 1 | 1 + follow-up | 1 + 2 follow-ups | 2 independent + cross-compare |
| paper-claim-audit | depth | skip | basic 4 checks | full 6 checks | line-by-line + reproduce |
