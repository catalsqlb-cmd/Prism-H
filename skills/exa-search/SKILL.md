...
| Skill | Best for |
|------|----------|
| `/semantic-scholar` | Published venue papers (journals, university presses), citation counts |
| `/exa-search` | Broad web search: blogs, docs, news, institutions, research papers — with content extraction |
...
- Combine with `/semantic-scholar` or `/research-lit` for comprehensive literature coverage
