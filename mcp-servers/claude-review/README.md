...
Bridge Codex-first Prism workflows to the local Claude Code CLI.
...
- By default the reviewer gets **no tools**. This matches the original Prism pattern where the external reviewer only sees the prompt context prepared by the executor.
