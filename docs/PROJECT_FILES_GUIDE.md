...
> How to organize project-level state files for Prism research workflows — what each file does, when to write it, and how they relate to each other.

## The Problem

Prism workflows generate a lot of information across multiple stages: ideas, experiment plans, results, review feedback, decisions. Without clear file conventions, this information gets scattered across chat sessions and lost on context compaction or new sessions.
...
### Existing Prism Files (unchanged)
...
Prism skills use timestamped filenames to preserve history. Each output is written twice:
